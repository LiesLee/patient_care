...
import com.views.city_select.datepick.WheelView;
    ...
    public void setSelectedItem(String province, String city, String county) {
        for (int i = 0; i < provinceList.size(); i++) {
            ...
            if (pro.contains(province)) {
                ...
                KLog.d("init select province: " + pro);
                break;
            }
        }
        ...
        for (int k = 0; k < counties.size(); k++) {
            ...
            if (cou.contains(county)) {
                ...
                KLog.d("init select county: " + cou);
                break;
            }
        }
        KLog.d(String.format("init select index: %s-%s-%s", selectedProvinceIndex, selectedCityIndex, selectedCountyIndex));
    }
