...
/**
 * Created by LiesLee on 16/11/25.
 */
public class RadiusWebView extends ProgressWebView {
    public RadiusWebView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
...
//    }
    ...
    public void draw(Canvas canvas) {
        ...
        paint2 = new Paint();
        paint2.setXfermode(null);
        m_radius = ViewUtil.dp2px(getContext() , 12);
